...
public class SecurityConfig extends WebSecurityConfigurerAdapter
{
  ...
  protected void configure(AuthenticationManagerBuilder auth) throws Exception
  {
    ...
    auth.inMemoryAuthentication()
        ...
        .withUser(users.username("mary").password("test123").roles("USER", "SUPER_ADMIN"))
        .withUser(users.username("susan").password("test123").roles("USER", "SUPER_ADMIN", "SUPER_SUPER_ADMIN"));
  }
  ...
  protected void configure(HttpSecurity http) throws Exception
  {
    ...
    http.authorizeRequests()
        .antMatchers(HttpMethod.GET, "/api/customers").hasAnyRole("USER", "ADMIN", "SUPER_ADMIN")
        .antMatchers(HttpMethod.GET, "/api/customers/**").hasAnyRole("USER", "ADMIN", "SUPER_ADMIN")
        .antMatchers(HttpMethod.POST, "/api/customers").hasAnyRole("ADMIN", "SUPER_ADMIN")
        .antMatchers(HttpMethod.POST, "/api/customers/**").hasAnyRole("ADMIN", "SUPER_ADMIN")
        .antMatchers(HttpMethod.PUT, "/api/customers").hasAnyRole("ADMIN", "SUPER_ADMIN")
        .antMatchers(HttpMethod.PUT, "/api/customers/**").hasAnyRole("ADMIN", "SUPER_ADMIN")
        .antMatchers(HttpMethod.DELETE, "/api/customers/**").hasRole("SUPER_ADMIN")
        .anyRequest()
        .authenticated()
        .and()
        .httpBasic()
